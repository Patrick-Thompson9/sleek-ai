...
const Showcase = ({ slice }: ShowcaseProps): JSX.Element => {
  return (
    ...
    >
      ...
      <div className="mt-16 grid items-center gap-8 rounded-xl border-blue-50/20 bg-gradient-to-b from-slate-50/15 p-8 backdrop-blur-sm lg:grid-cols-3 lg:gap-0 lg:py-12">
        <div>
